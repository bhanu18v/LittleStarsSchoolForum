...
namespace SchoolForum.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            {
                return Content("You are not authorised to create a new category");
            }
            return View();
        }
        ...
        public ActionResult Edit(int? id)
        {
            ...
            if (!User.IsInRole("Teacher"))
            {
                return Content("You are not authorised to edit a category");
            }
            return View(category);
        }
        ...
        public ActionResult Delete(int? id)
        {
            ...
            if (!User.IsInRole("Teacher"))
                {
                return Content("You are not authorised to delete a category");
            }
